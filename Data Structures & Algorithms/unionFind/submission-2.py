class UnionFind:
    ...
    def find(self, x: int) -> int:
        ...
        # it goes each and every step to find the root node
        ...
        if x == self.store[x]:
            return x
        # checkout this issue here
        #  I should recurse on the parent not on the x itself
        self.store[x] = self.find(self.store[x])
