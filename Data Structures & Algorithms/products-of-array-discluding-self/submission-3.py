class Solution:
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        ...
        # Optimal soultion with O(N) - time compexity and O(N) space complexity
        # prefix = [1]*len(nums)
        # postfix = [1]*len(nums)
        # result = [1]*len(nums)
        ...
        #  we can do it with without creating an prefix and postfix array.
        result=[1]*len(nums)

        #  iterate the elements and get the prefix and put it in the result
